/*
  HalfDuplexHardwareSerial_private.h - Hardware halfDuplexSerial library for Wiring
...
// HalfDuplexHardwareSerial constructor also works, but makes the code bigger and
// slower.
#if !defined(TXC0)
#if defined(TXC)
...
#define UDRE0 UDRE1
#else
#error No UART found in HalfDuplexHardwareSerial.cpp
#endif
#endif // !defined TXC0
...
HalfDuplexHardwareSerial::HalfDuplexHardwareSerial(
...
void HalfDuplexHardwareSerial::_rx_complete_irq(void)
{
